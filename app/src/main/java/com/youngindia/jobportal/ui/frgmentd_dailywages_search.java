...
public class frgmentd_dailywages_search extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final Spinner wages=(Spinner)rootview.findViewById(R.id.spinner_wages);
        ...
        btn_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
...

                {
                    ...
                    Intent intent = new Intent(getActivity().getApplicationContext(), Search_list_Activity.class);
